...
import TvProductTechDetail from './TvProductTechDetail'
      ...
      <Grid container spacing={1}>
        ...
        <Grid item xs={5}>
          <Item>
            ...
            <p style={{ textAlign: 'left' }}>
              Product is available at any of our sales outlet
              <br />
              ...
              Brand :<br />
              Material :<br />
              Item dimensions L x W x H 18.2 x 11 x 2.8 centimetres
              <br />
              Weight : 454 Grams
              <br />
        ...
        <Grid item xs={4}>
          <Item style={{ textAlign: 'left' }}>
            ...
            <br />
            <p>
              FREE delivery, on<strong>Mondays</strong> and
              <strong>Wednesday</strong> within Finland,for evey first Order
            </p>
          ...
          <Item style={{ textAlign: 'left' }}>
            <br />
            <br />
            {/*Placing Tv product techenical detail here*/}
            <TvProductTechDetail />
          </Item>
        </Grid>
      </Grid>
